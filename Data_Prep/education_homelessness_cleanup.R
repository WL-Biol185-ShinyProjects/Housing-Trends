...
homeless_enrolled_2013_14$year <- NULL
homeless_enrolled_2013_14$STNAM <- NULL
colnames(homeless_enrolled_2013_14)[2] <- "2013-14"
...
homeless_enrolled_2014_15$year <- NULL
homeless_enrolled_2014_15$STNAM <- NULL
colnames(homeless_enrolled_2014_15)[2] <- "2014-15"
homeless_enrolled_2015_16 <- read_csv("Data/Homelessness/lea-homeless-enrolled-sy2015-16.csv", 
                                      col_types = cols(CDW = col_skip(), DATE_CUR = col_skip(), 
                                                       ...
                                                       SHELTERED = col_skip(), SUBGRANT_STATUS = col_skip(), 
                                                       UHY = col_skip(), UNSHELTERED = col_skip())) %>% filter(STNAM == "VIRGINIA")
homeless_enrolled_2015_16$year <- NULL
homeless_enrolled_2015_16$STNAM <- NULL
colnames(homeless_enrolled_2015_16)[2] <- "2015-16"
homeless_enrolled_2016_17 <- read_csv("Data/Homelessness/lea-homeless-enrolled-sy2016-17.csv", 
                                        col_types = cols(CDW = col_skip(), DATE_CUR = col_skip(), 
                                                         ...
                                                         UHY = col_skip(), UNSHELTERED = col_skip())) %>% filter(STNAM == "VIRGINIA")
homeless_enrolled_2016_17$year <- NULL
homeless_enrolled_2016_17$STNAM <- NULL
colnames(homeless_enrolled_2016_17)[2] <- "2016-17"
homeless_enrolled_2017_18 <- read_csv("Data/Homelessness/lea-homeless-enrolled-sy2017-18.csv", 
                                      col_types = cols(CWD = col_skip(), DATE_CUR = col_skip(), 
                                                       ...
                                                       SUBGRANT_STATUS = col_skip(), UHY = col_skip(), 
                                                       UNSHELTERED = col_skip())) %>% filter(STNAM == "VIRGINIA")
homeless_enrolled_2017_18$year <- NULL
homeless_enrolled_2017_18$STNAM <- NULL
colnames(homeless_enrolled_2017_18)[2] <- "2017-18"
homeless_enrolled_2018_19 <- read_csv("Data/Homelessness/lea-homeless-enrolled-sy2018-19-wide.csv", 
                                       col_types = cols(CWD = col_skip(), DATE_CUR = col_skip(), 
                                                        ...
                                                        ST_LEAID = col_skip(), SUBGRANT_STATUS = col_skip(), 
                                                        UHY = col_skip(), UNSHELTERED = col_skip())) %>% filter(STNAM == "VIRGINIA")
homeless_enrolled_2018_19$year <-NULL
homeless_enrolled_2018_19$STNAM <- NULL
colnames(homeless_enrolled_2018_19)[2] <- "2018-19"
#Left Join all files
homeless_enrolled <-
...
homeless_students_enrolled <- gather(homeless_enrolled, key = "year", value = "student_counts", `2013-14`:`2018-19`)
