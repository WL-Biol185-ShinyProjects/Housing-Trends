...
homelessness <- ggplot(X2010_2015_PIT_Counts_by_State, aes(x=Year, y=Total_Homeless)) + geom_line(size=0.75) + 
  labs(x ="Year", y = "People (Counts)", caption  = "Source: 2015 Annual Homeless Assessment Report (AHAR)") +  scale_color_brewer(palette = "Spectral")
